...
public class UserMapperTest {
	...
	public void testInsert() throws Exception {
		userOneMapper.insert(new User("xxx", "a123456", UserSexEnum.MAN));
		userOneMapper.insert(new User("yyy", "b123456", UserSexEnum.WOMAN));
		userTwoMapper.insert(new User("zzz", "b123456", UserSexEnum.WOMAN));
/*
